...
# 1. if
temperature = float(input(f"Please enter today's temperature in degrees Celsius:\n "))
if temperature > 25:
...
if score >=70 and score <=100:
   ...
   sys.exit() # Terminate the script since the user gave invalid input

# 4. match
# NB: match works in Python 3.10 and above only. Match is similar to 'switch' in 'C' and its derived languages.
