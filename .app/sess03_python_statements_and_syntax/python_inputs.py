# Python file/script to demonstrate getting and working with user input
...
second_number = int(input(f"Please enter the first number/value to be used in the calculation:\n"))
