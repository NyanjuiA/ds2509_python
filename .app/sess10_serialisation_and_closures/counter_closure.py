...
# Display the return type fo the counter() function
print(f"The counter function returns: {type(c1)}")

# Display the first 10 values of using c1 using a for loop
for n in range(10):
   print(f"Current value of counter 1 is: {c1()}")

# Display the first 5 values of 'c2' manually
print(f"\nValues for counter 2 are:")
