...
# Get and display a list of even Fibonacci numbers using the filter function
even_fibonacci = list(filter(lambda x: x % 2 == 0, numbers))
print(f"Fibonacci numbers:\n{numbers}\nEven Fibonacci numbers:\n{even_fibonacci}")

# Set of student names
student_names =  {"Abigail","Bernice","Charlene","Denise","Sue","Jim","Mark",'Micha',
                  "William",'Jane','Xi',"Alfred",'Hillary',"Anthony",'Brigid','Mitchell'
                  "Alice"}
...
# Set the range of numbers that we'd liek to get prime numbers
num_range = range(1,70)

prime_numbers = list(filter(is_prime, num_range))
print(f"The prime numbers between 1 - 70 are:\n{prime_numbers}\n")
